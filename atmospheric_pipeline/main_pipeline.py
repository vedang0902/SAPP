...
DEFAULT_CONFIG = {
    ...
    "prediction": {
        ...
        "sarima_min_seasons": 24,
        "sarima_heartbeat_seconds": 60,
        "sarima_maxiter": 10,
        "sarima_disp": False,
        ...
        "split_weights_by_primary": True,
        "forecast_error_threshold": 2.5,
        "forecast_error_mode": "adaptive",
        "forecast_error_k": 3.0,
        "forecast_error_warmup_rows": 48,
        "error_window": 30,
        "rolling_forecast_tail_rows": 600,
        "rolling_log_interval": 100,
    },
    "drift": {
